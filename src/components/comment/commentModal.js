...
export default function CommentModal({ theme }) {
          ...
          >
            ...
            >
              <div
                className={
                  theme === "light"
                    ? "border-b border-gray-200 py-2 px-1.5"
                    : "border-b border-gray-500 py-2 px-1.5"
                }
              >
                <div
                ...
                <div
                  className={
                    theme === "light"
                      ...
                      : "w-full divide-y divide-gray-500"
                  }
                >
                  <div className="">
                    <textarea
                  ...
                  <div className="flex items-center justify-between pt-2.5">
                    <div className="flex">
                      ...
                      <EmojiHappyIcon onClick={()=>setEmoji(true)} className="h-10 w-10 hoverEffect p-2 text-sky-500 hover:bg-sky-100" />
                      {emoji && (
                        <div
